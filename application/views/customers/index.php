    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>
            Customers
            <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Add New Customer</button>
          </h1>
        </div>
        <div class="col-sm-6">
      ...
      <form role="form" action="<?php echo base_url('customers/create') ?>" method="post" id="createForm">
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="name" placeholder="Enter customer name" autocomplete="off">
          </div>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('customers/update') ?>" method="post" id="updateForm">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="model">Name</label>
            <input type="text" class="form-control" id="edit_name" name="edit_name" placeholder="Enter customer name" autocomplete="off">
          </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    manageTable = $('#manageTable').DataTable({
      'ajax': base_url + 'customers/fetchCustomerData',
      'responsive': true,
      'autoWidth': false,
      'iDisplayLength': 25,
    });
  ...
  function editFunc(id) {
    $.ajax({
      url: base_url + 'customers/fetchCustomerDataById/' + id,
      type: 'post',
      dataType: 'json',
      success: function(response) {
